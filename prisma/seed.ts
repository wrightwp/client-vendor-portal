...
async function main() {
  ...
  // Create B&E Summaries for Client 1 (2026 Current Plan Year)
  await prisma.clientBillingEnrollment.create({
    data: {
      ...
      priorStopLossCarrier: "Sun Life Assurance",
      priorManagingGeneralUnderwriter: "Sun Life Financial",
      ...
      figuresTotal: "194",
      domesticClaims: "No",
      notes: "2026 Plan Year: ASR’s core medical administration fee is guaranteed for 12 months; however, utilization management, large-case management, and network access fees are subject to change annually.",
    },
  });

  // Create B&E Summary for Client 1 (2025 Prior Plan Year)
  await prisma.clientBillingEnrollment.create({
    data: {
      clientId: client1.id,
      planYear: "2025",
      ...
      endDate: "2025-12-31",
      isCurrent: false,
      currentStopLossCarrier: "Sun Life Assurance",
      currentManagingGeneralUnderwriter: "Sun Life Financial",
      priorStopLossCarrier: "Voya Financial",
      priorManagingGeneralUnderwriter: "Voya Stop-Loss",
      specificDeductible: "$65,000.00 per individual",
      aggregatingSpecificDeductible: "No",
      noLaserRenewalGuarantee: "No",
      maxSpecificPremiumRenewalIncrease: "35%",
      laseredIndividuals: "No",
      specificPremiumSingle: "$148.50",
      specificPremiumEmployeePlusOne: "$278.20",
      specificPremiumFamily: "$412.10",
      specificBenefitsCovered: "Med/Rx",
      specificContract: "pi (paid & incurred) 12/12",
      aggregatePremium: "$6.90",
      monthlyAggregateAccommodation: "$1.25 (not included in aggregate premium)",
      aggregateFactorSingle: "$398.20",
      aggregateFactorEmployeePlusOne: "$740.10",
      aggregateFactorFamily: "$1,120.40",
      aggregateMinAttachmentPoint: "$1,310,500.00",
      aggregateBenefitsCovered: "Med/Rx",
      aggregateContract: "pi (paid & incurred) 12/12",
      aggregateRunInLimit: "No",
      organTransplantPolicy: "No",
      compositeAdminFee: "$49.50 per employee per month",
      medicalFee: "Included ($49.00 per employee per month)",
      urFee: "Included ($2.50 per employee per month)",
      amwellFee: "Included ($0.40 per employee per month)",
      physiciansCareHapFee: "Included ($9.50 per employee per month)",
      wrapNetwork: "Aetna 25% | Fair Cost 25%",
      aetnaSignatureAdminFee: "Included ($15.50 per employee per month)",
      networkAccessFee: "Included ($15.00 per employee per month)",
      reinsuranceFee: "Included ($0.70 per employee per month)",
      lcmSpaFee: "$140.00 per hour",
      agentFee: "$30.00 per employee per month",
      ppoFee: "$8.50 per employee per month",
      pbmRx: "Express Scripts",
      rxIncludedInAsrReporting: "Yes",
      isRxAsrContract: "Yes",
      pbmAgentCompensation: "No",
      stopLossCommission: "0%",
      stopLossOtherCompensation: "2.5%",
      commissionAgentCompensation: "No",
      figuresSingle: "115",
      figuresEmployeePlusOne: "34",
      figuresFamily: "28",
      figuresTotal: "177",
      domesticClaims: "No",
      notes: "2025 Plan Year: Prior historical contract terms with Sun Life Assurance.",
    },
  });
