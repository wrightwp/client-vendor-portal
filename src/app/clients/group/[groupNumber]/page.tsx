...
export default async function ClientByGroupNumberPage({
  params,
}: {
  ...
  if (matchedClient) {
    redirect(`/clients/${matchedClient.id}`);
  }
  ...
  return (
    <div style={{ padding: "3rem 1.5rem", maxWidth: "600px", margin: "0 auto", textAlign: "center" }}>
      ...
      >
        ...
        <Link href="/clients" className="btn btn-primary" style={{ marginTop: "0.5rem" }}>
          <ArrowLeft size={16} />
